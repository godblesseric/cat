package com.zs.cat.base.startup;
...
public class Bootstrap extends AbstractIdleService implements ServletContextListener {
    ...
    protected void startUp() throws Exception {
        LOGGER.info("===================cat-base START BEGIN==========================");
        Long startTime = System.nanoTime();
        context = new ClassPathXmlApplicationContext(new String[]{"config/spring/base-context.xml"});
        context.start();
        ...
        LOGGER.info("===================cat-base START END==========================");
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        LOGGER.info("cat-base service started ");
        try {
            startUp();
        } catch (Exception ex) {
            ex.printStackTrace();
