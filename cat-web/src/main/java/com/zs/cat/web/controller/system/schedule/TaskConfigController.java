/*package com.zs.cat.web.controller.system.schedule;
 ...
 *//*
@Controller
@RequestMapping(value="/taskConfigController")
public class TaskConfigController extends BaseController {
	
	String menuUrl = "taskConfig/listTaskConfigs.do"; //菜单地址(权限用)
	
	@Resource(name="taskConfigService")
